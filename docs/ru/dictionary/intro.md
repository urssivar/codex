...
*5,171 лексем, база 20.05.2025, документ 27.05.2025*
...
* Существительные (*СУЩ.*) приводятся в именительном падеже (++тьу́пп++ 'палец'), далее указываются форма косвенного падежа (++тьуппу́-++), и множественное число (++тьиппе́++ 'пальцы'). В некоторых случаях заглавное слово уже является формой множественно числа (*МН.*). Редко присутствует нерегулярная местная форма (++яша́ккан-++ 'в кастрюле').

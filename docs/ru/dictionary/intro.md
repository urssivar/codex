...
* Существительные (*СУЩ.*) приводятся в именительном падеже, далее указываются форма косвенного падежа, (редко) нерегулярный локатив и множественное число. В некоторых случаях заглавное слово уже является формой множественно числа (*МН.*).
...
* Количественные числительные (*ЧИСЛ.*) содержат форму косвенного падежа и основу.

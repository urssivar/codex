...
* Существительные (*СУЩ.*) приводятся в именительном падеже, далее указываются форма косвенного падежа, (редко) нерегулярная локативная форма и форма множественного числа. В некоторых случаях заглавная форма уже является формой множественного числа (*МН.*).
* Глаголы (*ГЛ.*) приводятся в форме несовершенного инфинитива, далее (при наличии) указываются совершенный инфинитив и форма законченного действия (аорист).

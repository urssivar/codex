...
Using the negative copula ++акку++ (and its conjugations) we form the common phrase ++акку у++ *"isn't it"*.
...
Вопросы *по содержанию*, которым нужен полный ответ, отмечаются частицей ++йа++. Им всегда нужно предшествующее вопросительное слово.
...
*Риторические* вопроса передают общий смысл *"хмм, интересно..."*. И *полярные*, и вопросы *по содержанию* становятся *риторическими* когда за ними следует частица ++ра++.

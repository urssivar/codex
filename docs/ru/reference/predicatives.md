...
- [полярные вопросы](./questions#_1-полярные) — ++у++;  
  ++уцци ҡил ==у==?++  
  --брат дома?--  
- [вопросы содержания](./questions#_2-по-содержанию) — ++йа / ай++.  
  ++ҡил ча ==йа==?++  
  --кто дома?--
...
Важно, что 3-е лицо связки ["быть"](./copulas#_1-факты) ++це++ всегда заменяется полностью.
